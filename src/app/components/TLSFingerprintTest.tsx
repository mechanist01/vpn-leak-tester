                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <div className="text-center mt-2 text-sm opacity-75">
                                powered by <a href="https://replit.com/@ryanaregister/VLT-BE" className="underline hover:opacity-100" target="_blank" rel="noopener noreferrer">flask using replit</a>
                            </div>
                        </div>
                    </div>
                </div>
